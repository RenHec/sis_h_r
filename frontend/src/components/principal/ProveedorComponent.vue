...
export default {
  ...
  methods: {
    ...
    initialize() {
      this.loading = true
      this.$store.state.services.ProveedorCatalogoService.getAll()
        .then((r) => {
    ...
    destroy(data) {
      this.$swal({
        ...
        if (result.value) {
          this.loading = true
          this.$store.state.services.ProveedorCatalogoService.delete(data)
            .then((r) => {
    ...
    update(data) {
      this.$swal({
        ...
        if (result.value) {
          this.loading = true
          this.$store.state.services.ProveedorCatalogoService.update(data)
            .then((r) => {
              this.$toastr.success(r.data, 'Mensaje')
              this.initialize()
            })
